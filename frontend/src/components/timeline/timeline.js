            ...
            <div className={styles.main}> 
                ...
                <div className={styles.sliderbox}>
                    <div 
                        ...
                        style={{width: (((this.props.endTime.getTime() - this.props.startTime.getTime()) / (60 * 60 * 1000)) / this.props.scale) * 100 + "%"}}
                    >
                        ...
                        {getLinePlacements(this.props.startTime, this.props.timeSpan).map((p, i) => {
                            return ( 
                                <div
                                    style={{
                                        position: "absolute",
