...
class SerializeTest(TestCase):
    ...
    def test_deserialize_and_save(self):
        ...
        # Create a new camera.
        deserialize(data="{\"model\": \"backend.camera\", \"pk\": null, \"fields\": {\"latitude\": \"0.1\", \"longitude"
                         "\": \"1.0\", \"start_time\": \"2020-05-17T00:00:00Z\", \"end_time\": \"2020-05-18T00:00:00Z\""
                         "}}", save=True)
        ...
        deserialize(data="[{\"model\": \"backend.folder\", \"pk\": null, \"fields\": {\"parent\": 1, \"path\": "
                         "\"/home/user/test_folder/\", \"name\": \"folder1\"}}, {\"model\": \"backend.folder\","
                         "\"pk\": null, \"fields\": {\"parent\": 1, \"path\": \"/home/user/test_folder/\", \"name\": "
                         "\"folder2\"}}]", save=True)
        ...
        deserialize(data="[{\"model\": \"backend.folder\", \"pk\": 3, \"fields\": {\"parent\": 2, \"path\": "
                         "\"/home/user/test_folder/test_subfolder/\", \"name\": \"folder1\"}}, "
                         "{\"model\": \"backend.folder\", \"pk\": 4, \"fields\": {\"parent\": 2, \"path\": "
                         "\"/home/user/test_folder/test_subfolder\", \"name\": \"folder2\"}}]", save=True)
