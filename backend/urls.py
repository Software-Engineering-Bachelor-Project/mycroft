...
urlpatterns = [
    ...
    path('project/getall', views.project_get_all, name='project get all'),
    ...
    path('export/videos', views.export_videos, name='export videos'),
    ...
    path('file/add_folder', views.file_add_folders, name='file add'),
